...
public interface MovieRepository extends JpaRepository<Movie, Integer> {
	...
	@Query(nativeQuery = true, value = "SELECT id,name,type,release_date FROM movie ")
	public List<Map<String, Object>> getForSiteWithoutName();

	@Query(nativeQuery = true, value = "SELECT id,name,type,release_date FROM movie where LOWER(name) LIKE %:name%")
